...
<html>
  <head>
  <?php require 'templefunction/db_connector.php'; error_reporting(0); ?>
    ...
    <div class="container">
      ...
      <form class="form-signin" method="post" >
       ...
       <label>Password</label>
        ...
        <label>Clinic</label>
        <select id="select01" class="input-block-level" name="clinic">
                                              <option>--Select Clinic--</option>
                                    <?php
                                    
                                                                     
                                    $rs = mysql_query("select * from tblclinic");
...
if($_POST['button']){
	...
	echo '<meta http-equiv="refresh" content="0; URL=home.php?success=1">';
    }
}
    ?>   
      </form>
